...
export default {
  data() {
   return {
     listitems: [
       {name:'个人网站',url:'/my_message/jj',icon:'icon-delect', clik: true, items:[
         {name:"挖坑填土",url:'/my_message/jj',clik:true},{name:"关于我",url:'/my_message/hj',clik:false},{name:"关于网站",url:'/my_message/jl',clik:false}]},
       {name:'我的博客',url:'/docum/jd',icon:'icon-document', clik: false,items:[
         {name:"基数排序",url:'/docum/jd',clik:true},{name:"c/c++留恋",url:'/docum/c',clik:false},{name:"关于后端",url:'/docum/hd',clik:false}]},
       {name:'我的音乐',url:'/musics',icon:'icon-music', clik: false,items:[]},
       {name:'游戏视频',url:'/videos',icon:'icon-video', clik: false,items:[]},
       {name:'小游戏',url:'/games/bw',icon:'icon-game', clik: false,items:[
